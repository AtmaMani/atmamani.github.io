...
BLOG_EMAIL = "atma.mani@outlook.com"
    ...
    DEFAULT_LANG: (
        (
            (
                ...
                ('/projects/cloud/', "Cloud computing"),
        ...
        (
            (
                ...
                ('/', "<hr>"),
                ('/cheatsheets/python/python_datatypes/', "Python datatypes"),
                ('/cheatsheets/python/python_numeric_datatypes/', "Python numeric datatypes"),
                ('/cheatsheets/python/python_conditional_execution/', "Python conditional execution"),
                ('/cheatsheets/python/python_functions/', "Python functions"),
                ...
                ('/cheatsheets/python/python_language_optimizations/', "Python - language optimizations"),
                ('/images/regex-mindmap.jpg', "Python regex"),
                ('/', "<hr>"),
                ('/cheatsheets/golang/', "Go introduction"),
                ('/cheatsheets/golang/golang-basics/', "Go basics"),
                ('/cheatsheets/golang/golang-datatypes/', "Go data types"),
                ('/cheatsheets/golang/golang-control-flow/', "Go control flow"),
                ('/cheatsheets/golang/goroutine/', "Goroutines - concurrency in Go lang"),
                ('/', "<hr>"),
                ...
                ('/', "<hr>"),
                ('/cheatsheets/pandas/pandas_cheat_sheet_1/', "Pandas basics"),
                ('/cheatsheets/pandas/pandas_cheat_sheet_2/', "Pandas multilevel index, <br>    missing data, aggregation, merging"),
                ('/cheatsheets/pandas/pandas_cheat_sheet_3/', "Productivity with Pandas"),
                ('/cheatsheets/pandas/pandas_data_viz_1/', "Pandas data visualization"),
                ('/', "<hr>"),
                ...
                ('/cheatsheets/seaborn/seaborn_cheat_sheet_3/', "Seaborn matrix, regression - heatmap, <br> cluster, regression"),
                ('/cheatsheets/seaborn/seaborn_cheat_sheet_4/', "Seaborn grids & custom - pair, facet grids <br> customization"),
                ('/', "<hr>"),
                ('/cheatsheets/plotly/plotly_cufflinks_cheat_sheet_1/', "Plotly introduction"),
                ('/cheatsheets/plotly/plotly_cufflinks_cheat_sheet_2/', "Plotly - interactive plotting"),
                ('/cheatsheets/plotly/plotly_geographical_plotting_1/', "Plotly - geographic plotting"),
                ('/', "<hr>"),
                ('/cheatsheets/r_cheat_sheet_1/', "R basics"),
                ('/cheatsheets/octave-1/', "Octave / MATLAB - basics"),
                ('/cheatsheets/octave-2/', "Octave - handling data"),   
                ('/cheatsheets/js_essentials/', "Javascript essentials"),
                ('/cheatsheets/latex-1/', "Latex introduction"),
                ('/cheatsheets/docker-1/', "Docker introduction"),
                ('/cheatsheets/grep-1/', "Grep introduction"),
                ('/', "<hr>"),
                ('/cheatsheets/sql/sql-1', "SQL introduction"),
                ('/cheatsheets/sql/sql-2', "SQL Operators and sorting rows"),
                ('/cheatsheets/sql/sql-3', "SQL Joining tables"),
                ('/cheatsheets/sql/sql-problem-sets-1', "SQL Problem Sets"),
                ('/', "<hr>"),
                ('/cheatsheets/open-geo/geopandas-1/', "GeoPandas - IO, projections, plotting"),
                ('/cheatsheets/open-geo/geopandas-2/', "GeoPandas - GP, IO, interactive plotting, geocoding"),
                ('/cheatsheets/open-geo/geopandas-3/', "GeoPandas - spatial overlays, topology"),
                ...
                ('/cheatsheets/open-geo/gdal_t1/', "GDAL training day 1"),
                ('/cheatsheets/open-geo/gdal_t2/', "GDAL training day 2"),
                ('/cheatsheets/open-geo/gdal_t3/', "GDAL training day 3"),
                ('/', "<hr>"),
...
MARKDOWN_EXTENSIONS = ['markdown.extensions.fenced_code', 'markdown.extensions.meta', 'markdown.extensions.codehilite', 'markdown.extensions.extra', 'markdown.extensions.toc']
